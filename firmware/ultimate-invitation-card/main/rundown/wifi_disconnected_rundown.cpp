#include <memory.h>
#include "wifi_disconnected_rundown.hpp"
...
void wifi_disconnected_rundown::load( ::espena::i_playbook *pb ) {

  ::espena::playbook_item pi;
  
  memset( &pi, 0x00, sizeof( pi ) );
  pi.type = ::espena::playbook_item_type::menu;
  pi.params.event[ ::espena::menu_key::A ] = ::espena::menu_select::respond;
  ...
  pi.buf = iso8859_1_text[ iso8859_1_text_id::txt_wifi9 ][ 0 ];
  pb->add( pi );
